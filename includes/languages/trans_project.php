...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("Mobile");                                                                // Line 170
	echo T_("Email");                                                                 // Line 179
	...
	echo T_("Your Message");                                                          // Line 102
	echo T_("Send");                                                                  // Line 108
	...
	echo T_("We do our best to improve our service quality. So, knowing your valuable comments will help us in this way.");// Line 10
	echo T_("Iran");                                                                  // Line 44
	echo T_("Qom");                                                                   // Line 103
	...
	echo T_("Certificate");                                                           // Line 91
	echo T_("Secured by Arvancloud");                                                 // Line 92
	echo T_("Arvancloud");                                                            // Line 92
	echo T_("Last news");                                                             // Line 133
